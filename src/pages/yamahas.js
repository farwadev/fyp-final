...
//  images  icons
import img8 from "../images/ya3.jpg";
import img9 from "../images/ya4.jpg";
import img10 from "../images/ya5.jpg";
import "../pages/style/hero.css";
// rzr
import img11 from "../images/ya6.jpg";
import img12 from "../images/ya7.jpg";
import img13 from "../images/ya8.jpg";
//  images for slider
import img1 from "../images/ya.jpg";
import img2 from "../images/ya1.jpg";
import img3 from "../images/ya2.jpeg";
function yahamas(props) {
    return (
        <div>
            <Navbar/>
             {/* slider */}
        ...
        <div className="container py-4 py-md-5">
          <div className="row">
            <div className="col-12">
              <h2 className="fs-15 text-uppercase text-center">YAHAMA</h2>
              <hr className="text-primary" />
              <h4 className="fs-15 text-uppercase text-center">YAHAMA SERIES</h4>
            </div>
          </div>

...
//  images  icons
import img8 from "../images/cv4.jpg";
import img9 from "../images/cv3.jpg";
import img10 from "../images/cv5.jpg";
import "../pages/style/hero.css";
// rzr
import img11 from "../images/cv6.jpg";
import img12 from "../images/cv7.jpg";
import img13 from "../images/cv8.jpg";
//  images for slider
import img1 from "../images/CV.webp";
import img2 from "../images/CV1.jpg";
import img3 from "../images/CV2.jpg";
function Chevrolet(props) {
    return (
        <div>
            <Navbar/>
             {/* slider */}
      ...
      <section class="wrapper">
        <div class="container py-4 py-md-5">
          <div class="row">
            <div class="col-12">
              <h2 class="fs-15 text-uppercase text-center">CHEVROLET</h2>
              <hr class="text-primary" />
              <h4 class="fs-15 text-uppercase text-center">CHEVROLET SERIES</h4>
            </div>
          </div>
          <div class="row align-items-center counter-wrapper gy-4 gy-md-5 text-center">
            <div class="col-md-4">
              <img src={img9} alt="" class="img-fluid" />
              <h6 class="counter">Chevrolet Suburban</h6>
            </div>

            <div class="col-md-4">
              <img src={img8} alt="" class="img-fluid" />
              <h6 class="counter">Chevrolet Cruze</h6>
            </div>

            <div class="col-md-4">
              <img src={img10} alt="" class="img-fluid" />
              <h6 class="counter">Chevrolet Impala</h6>
            </div>
          </div>
        </div>
      </section>
        ...
        <div class="container py-4 py-md-5">
          ...
          <div class="row align-items-center counter-wrapper gy-4 gy-md-5 text-center">
            <div class="col-md-4">
              ...
              <h6 class="counter">Chevrolet Corvette</h6>
            </div>

            <div class="col-md-4">
              <img src={img12} alt="" class="img-fluid" />
              <h6 class="counter">Chevrolet Traverse</h6>
            </div>

            <div class="col-md-4">
              <img src={img13} alt="" class="img-fluid" />
              <h6 class="counter">Chevrolet Camaro</h6>
            </div>
          </div>
        </div>
      </section>

...
//  images  icons
import img8 from "../images/hu2.jpeg";
import img9 from "../images/hu1.jpeg";
import img10 from "../images/hu3.jpg";
import "../pages/style/hero.css";
// rzr
import img11 from "../images/hu4.jpg";
import img12 from "../images/hu5.jpg";
import img13 from "../images/hu6.jpg";
//  images for slider
import img1 from "../images/tu1.webp";
import img2 from "../images/tu2.jpg";
    ...
    return (
      ...
      <section class="wrapper">
        <div class="container py-4 py-md-5">
          <div class="row">
            <div class="col-12">
              <h2 class="fs-15 text-uppercase text-center">HYUNDAI</h2>
              <hr class="text-primary" />
              <h4 class="fs-15 text-uppercase text-center">HYUNDAI SERIES</h4>
            </div>
          </div>
          <div class="row align-items-center counter-wrapper gy-4 gy-md-5 text-center">
            <div class="col-md-4">
              <img src={img9} alt="" class="img-fluid" />
              <h6 class="counter">Sonata</h6>
            </div>

            <div class="col-md-4">
              <img src={img8} alt="" class="img-fluid" />
              <h6 class="counter">Elantra</h6>
            </div>

            <div class="col-md-4">
              <img src={img10} alt="" class="img-fluid" />
              <h6 class="counter">Tucson</h6>
            </div>
          </div>
        </div>
      </section>
        ...
        <div class="container py-4 py-md-5">
          ...
          <div class="row align-items-center counter-wrapper gy-4 gy-md-5 text-center">
            <div class="col-md-4">
              ...
              <h6 class="counter">Santa Fe</h6>
            </div>

            <div class="col-md-4">
              <img src={img12} alt="" class="img-fluid" />
              <h6 class="counter">Accent</h6>
            </div>

            <div class="col-md-4">
              <img src={img13} alt="" class="img-fluid" />
              <h6 class="counter">Nexo</h6>
            </div>
          </div>
        </div>
      </section>

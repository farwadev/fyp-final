...
import img8 from "../images/y4.jpg";
import img9 from "../images/y5.jpg";
import img10 from "../images/y6.jpg";
import "../pages/style/hero.css";
// 
import img11 from "../images/y7.jpg";
import img12 from "../images/y8.jpg";
import img13 from "../images/y9.jpg";
//  images for slider
import img1 from "../images/y1.jpg";
import img2 from "../images/y2.jpg";
import img3 from "../images/y3.jpg";

import Navbar from "../components/navbar";
import Footer from "../components/footer";
function yamaha(props) {
  return (
    <div>
      <Navbar />
      {/* slider */}
      ...
      <section class="wrapper">
        <div class="container py-4 py-md-5">
          <div class="row">
            <div class="col-12">
              <h2 class="fs-15 text-uppercase text-center">YAMAHA</h2>
              <hr class="text-primary" />
              <h4 class="fs-15 text-uppercase text-center">MT SERIES</h4>
            </div>
          </div>
          <div class="row align-items-center counter-wrapper gy-4 gy-md-5 text-center">
            <div class="col-md-4">
              <img src={img9} alt="" class="img-fluid" />
              <h6 class="counter">MT Series Pedigree</h6>
            </div>

            <div class="col-md-4">
              <img src={img8} alt="" class="img-fluid" />
              <h6 class="counter">MT 0-1</h6>
            </div>

            <div class="col-md-4">
              <img src={img10} alt="" class="img-fluid" />
              <h6 class="counter">F-Z 07</h6>
            </div>
          </div>
        </div>
      </section>
      ...
      <section class="wrapper">
        <div class="container py-4 py-md-5">
          <div class="row">
            <div class="col-12">
              <hr class="text-primary" />
              <h4 class="fs-15 text-uppercase text-center">MT-15 SERIES</h4>
            </div>
          </div>
          <div class="row align-items-center counter-wrapper gy-4 gy-md-5 text-center">
            <div class="col-md-4">
              <img src={img11} alt="" class="img-fluid" />
              <h6 class="counter">MT-125</h6>
            </div>

            <div class="col-md-4">
              <img src={img12} alt="" class="img-fluid" />
              <h6 class="counter">MT-125 Livery Variation</h6>
            </div>

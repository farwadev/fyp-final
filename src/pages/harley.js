...
import img8 from "../images/HARLEY7.jpg";
import img9 from "../images/HARLEY6.jpg";
import img10 from "../images/HARLEY8.jpg";
import "../pages/style/hero.css";
// rzr
import img11 from "../images/harley9.jpg";
import img12 from "../images/harley10.jpg";
import img13 from "../images/harley11.jpg";
// harley images for slider
import img1 from "../images/harley3.jpg";
import img2 from "../images/harley4.jpg";
import img3 from "../images/harley5.jpg";

function harley(props) {
  return (
    <div>
      <Navbar />
      {/* slider */}
      ...
      <section class="wrapper">
        <div class="container py-4 py-md-5">
          <div class="row">
            <h2 class="fs-15 text-uppercase text-center">HARLEY DAVIDSON</h2>
            <hr class="text-primary" />
            <h4 class="fs-15 text-uppercase text-center">CRUISER</h4>
          </div>
          <div class="row align-items-center counter-wrapper gy-4 gy-md-5 text-center">
            <div class="col-md-4">
              <img src={img8} alt="" class="img-fluid" />
              <h6 class="counter">Softail Standard</h6>
            </div>

            <div class="col-md-4">
              <img src={img9} alt="" class="img-fluid" />
              <h6 class="counter">Street Bob 114</h6>
            </div>

            <div class="col-md-4">
              <img src={img10} alt="" class="img-fluid" />
              <h6 class="counter">Sport Glide</h6>
            </div>
          </div>
        </div>
      </section>
      ...
      <section class="wrapper">
        <div class="container py-4 py-md-5">
          <div class="row">
            <hr class="text-primary" />
            <h4 class="fs-15 text-uppercase text-center">GRAND AMERICAN</h4>
          </div>
          <div class="row align-items-center counter-wrapper gy-4 gy-md-5 text-center">
            <div class="col-md-4">
              <img src={img11} alt="" class="img-fluid" />
              <h6 class="counter">Road King Special</h6>
            </div>

            <div class="col-md-4">
              <img src={img12} alt="" class="img-fluid" />
              <h6 class="counter">Ultra Limited</h6>
            </div>

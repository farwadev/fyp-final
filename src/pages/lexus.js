...
//  images  icons
import img8 from "../images/l4.jpg";
import img9 from "../images/l3.jpg";
import img10 from "../images/l5.jpg";
import "../pages/style/hero.css";
// rzr
import img11 from "../images/l6.jpg";
import img12 from "../images/l7.jpg";
import img13 from "../images/l8.jpg";
//  images for slider
import img1 from "../images/l.jpeg";
import img2 from "../images/l1.jpg";
import img3 from "../images/l2.jpg";
    ...
    return (
      ...
      <section class="wrapper">
        <div class="container py-4 py-md-5">
          <div class="row">
            <div class="col-12">
              <h2 class="fs-15 text-uppercase text-center">LEXUS</h2>
              <hr class="text-primary" />
              <h4 class="fs-15 text-uppercase text-center">LEXUS SERIES</h4>
            </div>
          </div>
          <div class="row align-items-center counter-wrapper gy-4 gy-md-5 text-center">
            <div class="col-md-4">
              <img src={img9} alt="" class="img-fluid" />
              <h6 class="counter">Lexus IS</h6>
            </div>

            <div class="col-md-4">
              <img src={img8} alt="" class="img-fluid" />
              <h6 class="counter">Lexus LS</h6>
            </div>

            <div class="col-md-4">
              <img src={img10} alt="" class="img-fluid" />
              <h6 class="counter">Lexus ES</h6>
            </div>
          </div>
        </div>
      </section>
        ...
        <div class="container py-4 py-md-5">
          ...
          <div class="row align-items-center counter-wrapper gy-4 gy-md-5 text-center">
            <div class="col-md-4">
              ...
              <h6 class="counter">Lexus UX</h6>
            </div>

            <div class="col-md-4">
              <img src={img12} alt="" class="img-fluid" />
              <h6 class="counter">Lexus GS</h6>
            </div>

            <div class="col-md-4">
              <img src={img13} alt="" class="img-fluid" />
              <h6 class="counter">Lexus RX</h6>
            </div>
          </div>
        </div>
      </section>
